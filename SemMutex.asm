...
IPC_semup_load_and_test:
    LD    R16 , Z                  ; Загрузили значение семафора
    CPI   R16 , 0                  ; Проверили значение семафора 0 - опущен 1- взведён
    BREQ  IPC_semup_set            ; Если семафор не взведён  то прыгаем на установку семафора
    TaskBreak                      ; Если взведён то отдаем вожжи ядру
